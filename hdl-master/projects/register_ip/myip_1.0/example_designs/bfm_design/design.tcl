proc create_ipi_design { offsetfile design_name } {
	...
	connect_bd_net -net aclk_net [get_bd_ports ACLK] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins master_0/M_AXI_LITE_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins myip_0/S00_AXI_ACLK]
	connect_bd_net -net aresetn_net [get_bd_ports ARESETN] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins master_0/M_AXI_LITE_ARESETN] [get_bd_pins myip_0/S00_AXI_ARESETN]
