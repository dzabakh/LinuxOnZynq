...
Command: %s
53*	vivadotcl23
place_design -directive Explore2default:defaultZ4-113
š
...
Explore2default:defaultZ46-5
t
...
%s
*constraints2s
_Time (s): cpu = 00:00:01 ; elapsed = 00:00:00.336 . Memory (MB): peak = 1013.758 ; gain = 0.0002default:default
ƒ

Phase %s%s
101*constraints2
...
V
JPhase 1.1.2 Build Super Logic Region (SLR) Database | Checksum: 149c21930
*common
Š

%s
*constraints2s
_Time (s): cpu = 00:00:01 ; elapsed = 00:00:00.358 . Memory (MB): peak = 1013.758 ; gain = 0.0002default:default
k

Phase %s%s
101*constraints2
...
>
2Phase 1.1.3 Add Constraints | Checksum: 149c21930
*common
Š

%s
*constraints2s
_Time (s): cpu = 00:00:01 ; elapsed = 00:00:00.359 . Memory (MB): peak = 1013.758 ; gain = 0.0002default:default
h

Phase %s%s
101*constraints2
...
%s
*constraints2o
[Time (s): cpu = 00:00:02 ; elapsed = 00:00:01 . Memory (MB): peak = 1013.758 ; gain = 0.0002default:default
|

Phase %s%s
101*constraints2
...
bAn IO Bus %s with more than one IO standard is found. Components associated with this bus are: %s
12*place2
gpio_bd2default:default2£
–
	<MSGMETA::BEGIN::BLOCK>gpio_bd[0]<MSGMETA::END> of IOStandard LVCMOS25
	<MSGMETA::BEGIN::BLOCK>gpio_bd[1]<MSGMETA::END> of IOStandard LVCMOS25
	<MSGMETA::BEGIN::BLOCK>gpio_bd[2]<MSGMETA::END> of IOStandard LVCMOS25
	<MSGMETA::BEGIN::BLOCK>gpio_bd[3]<MSGMETA::END> of IOStandard LVCMOS25
	<MSGMETA::BEGIN::BLOCK>gpio_bd[4]<MSGMETA::END> of IOStandard LVCMOS25
	<MSGMETA::BEGIN::BLOCK>gpio_bd[5]<MSGMETA::END> of IOStandard LVCMOS33
	<MSGMETA::BEGIN::BLOCK>gpio_bd[6]<MSGMETA::END> of IOStandard LVCMOS33
	<MSGMETA::BEGIN::BLOCK>gpio_bd[7]<MSGMETA::END> of IOStandard LVCMOS33
	<MSGMETA::BEGIN::BLOCK>gpio_bd[8]<MSGMETA::END> of IOStandard LVCMOS33
	<MSGMETA::BEGIN::BLOCK>gpio_bd[9]<MSGMETA::END> of IOStandard LVCMOS33
	<MSGMETA::BEGIN::BLOCK>gpio_bd[10]<MSGMETA::END> of IOStandard LVCMOS33
	<MSGMETA::BEGIN::BLOCK>gpio_bd[11]<MSGMETA::END> of IOStandard LVCMOS25
	<MSGMETA::BEGIN::BLOCK>gpio_bd[12]<MSGMETA::END> of IOStandard LVCMOS25
	<MSGMETA::BEGIN::BLOCK>gpio_bd[13]<MSGMETA::END> of IOStandard LVCMOS25
	<MSGMETA::BEGIN::BLOCK>gpio_bd[14]<MSGMETA::END> of IOStandard LVCMOS25
	<MSGMETA::BEGIN::BLOCK>gpio_bd[15]<MSGMETA::END> of IOStandard LVCMOS25
	<MSGMETA::BEGIN::BLOCK>gpio_bd[16]<MSGMETA::END> of IOStandard LVCMOS25
	<MSGMETA::BEGIN::BLOCK>gpio_bd[17]<MSGMETA::END> of IOStandard LVCMOS25
	<MSGMETA::BEGIN::BLOCK>gpio_bd[18]<MSGMETA::END> of IOStandard LVCMOS25
	<MSGMETA::BEGIN::BLOCK>gpio_bd[19]<MSGMETA::END> of IOStandard LVCMOS33
	<MSGMETA::BEGIN::BLOCK>gpio_bd[20]<MSGMETA::END> of IOStandard LVCMOS33
	<MSGMETA::BEGIN::BLOCK>gpio_bd[21]<MSGMETA::END> of IOStandard LVCMOS33
	<MSGMETA::BEGIN::BLOCK>gpio_bd[22]<MSGMETA::END> of IOStandard LVCMOS33
	<MSGMETA::BEGIN::BLOCK>gpio_bd[23]<MSGMETA::END> of IOStandard LVCMOS33
	<MSGMETA::BEGIN::BLOCK>gpio_bd[24]<MSGMETA::END> of IOStandard LVCMOS33
	<MSGMETA::BEGIN::BLOCK>gpio_bd[25]<MSGMETA::END> of IOStandard LVCMOS33
	<MSGMETA::BEGIN::BLOCK>gpio_bd[26]<MSGMETA::END> of IOStandard LVCMOS33
	<MSGMETA::BEGIN::BLOCK>gpio_bd[27]<MSGMETA::END> of IOStandard LVCMOS25
	<MSGMETA::BEGIN::BLOCK>gpio_bd[28]<MSGMETA::END> of IOStandard LVCMOS25
	<MSGMETA::BEGIN::BLOCK>gpio_bd[29]<MSGMETA::END> of IOStandard LVCMOS25
	<MSGMETA::BEGIN::BLOCK>gpio_bd[30]<MSGMETA::END> of IOStandard LVCMOS25
	<MSGMETA::BEGIN::BLOCK>gpio_bd[31]<MSGMETA::END> of IOStandard LVCMOS25"-
...
gpio_bd[30]: of IOStandard LVCMOS25
	"(
gpio_bd[31]: of IOStandard LVCMOS252default:default8Z30-12
O
CPhase 1.1.5 Implementation Feasibility check | Checksum: 1794cb8dd
*common
†

%s
*constraints2o
[Time (s): cpu = 00:00:02 ; elapsed = 00:00:02 . Memory (MB): peak = 1013.758 ; gain = 0.0002default:default
k

Phase %s%s
101*constraints2
...
>
2Phase 1.1.6 Pre-Place Cells | Checksum: 1794cb8dd
*common
†

%s
...
a
UPhase 1.1.7 IO Placement/ Clock Placement/ Build Placer Device | Checksum: 1c908e248
*common
†

%s
*constraints2o
[Time (s): cpu = 00:00:04 ; elapsed = 00:00:03 . Memory (MB): peak = 1013.758 ; gain = 0.0002default:default
v

Phase %s%s
101*constraints2
...
C
7Phase 1.1.8.1.1 Build Clock Data | Checksum: 2bb9720c4
*common
†

%s
*constraints2o
[Time (s): cpu = 00:00:09 ; elapsed = 00:00:06 . Memory (MB): peak = 1013.758 ; gain = 0.0002default:default
B
6Phase 1.1.8.1 Place Init Design | Checksum: 2440e03ae
*common
†

%s
*constraints2o
[Time (s): cpu = 00:00:09 ; elapsed = 00:00:07 . Memory (MB): peak = 1013.758 ; gain = 0.0002default:default
I
...
Q
EPhase 1.1.9.1 Constrain Global/Regional Clocks | Checksum: 1de06bc27
*common
†

%s
...
[Time (s): cpu = 00:00:09 ; elapsed = 00:00:07 . Memory (MB): peak = 1013.758 ; gain = 0.0002default:default
@
4Phase 1 Placer Initialization | Checksum: 1de06bc27
*common
†

%s
...
%s
*constraints2o
[Time (s): cpu = 00:00:36 ; elapsed = 00:00:27 . Memory (MB): peak = 1013.758 ; gain = 0.0002default:default
h

Phase %s%s
101*constraints2
...
%s
*constraints2o
[Time (s): cpu = 00:00:38 ; elapsed = 00:00:29 . Memory (MB): peak = 1013.758 ; gain = 0.0002default:default
p

Phase %s%s
101*constraints2
...
C
7Phase 3.3 Area Swap Optimization | Checksum: 1e9c44433
*common
†

%s
*constraints2o
[Time (s): cpu = 00:00:39 ; elapsed = 00:00:29 . Memory (MB): peak = 1013.758 ; gain = 0.0002default:default
o

Phase %s%s
101*constraints2
...
B
6Phase 3.4 Timing Path Optimizer | Checksum: 11f9fe325
*common
†

%s
*constraints2o
[Time (s): cpu = 00:00:40 ; elapsed = 00:00:30 . Memory (MB): peak = 1013.758 ; gain = 0.0002default:default
z

Phase %s%s
101*constraints2
...
M
APhase 3.5 Commit Small Macros & Core Logic | Checksum: 10a40b7dd
*common
†

%s
*constraints2o
[Time (s): cpu = 00:00:42 ; elapsed = 00:00:32 . Memory (MB): peak = 1013.758 ; gain = 0.0002default:default
l

Phase %s%s
101*constraints2
...
?
3Phase 3.6 Re-assign LUT pins | Checksum: 10a40b7dd
*common
†

%s
...
@
4Phase 4.1 PCOPT Shape updates | Checksum: 11ba96f36
*common
†

%s
*constraints2o
[Time (s): cpu = 00:00:42 ; elapsed = 00:00:33 . Memory (MB): peak = 1013.758 ; gain = 0.0002default:default
u

Phase %s%s
101*constraints2
...
Q
EPhase 4.2.1 Post Placement Timing Optimization | Checksum: 18fa7148c
*common
†

%s
*constraints2o
[Time (s): cpu = 00:00:45 ; elapsed = 00:00:34 . Memory (MB): peak = 1013.758 ; gain = 0.0002default:default
H
...
C
7Phase 4.3 Post Placement Cleanup | Checksum: 18fa7148c
*common
†

%s
...
C
7Phase 4.4.1 Congestion Reporting | Checksum: 18fa7148c
*common
†

%s
...
A
5Phase 4.4.2 updateTiming final | Checksum: 1478fb40c
*common
†

%s
*constraints2o
[Time (s): cpu = 00:00:47 ; elapsed = 00:00:35 . Memory (MB): peak = 1013.758 ; gain = 0.0002default:default
p

Phase %s%s
101*constraints2
...
C
7Phase 4.4.3 Dump Critical Paths  | Checksum: 1478fb40c
*common
†

%s
...
>
2Phase 4.4.5 Print Final WNS | Checksum: 1478fb40c
*common
†

%s
*constraints2o
[Time (s): cpu = 00:00:51 ; elapsed = 00:00:37 . Memory (MB): peak = 1013.758 ; gain = 0.0002default:default
=
1Phase 4.4 Placer Reporting | Checksum: 1478fb40c
*common
†

%s
*constraints2o
[Time (s): cpu = 00:00:51 ; elapsed = 00:00:38 . Memory (MB): peak = 1013.758 ; gain = 0.0002default:default
q

Phase %s%s
101*constraints2
...
D
8Phase 4.5 Final Placement Cleanup | Checksum: 19b70f246
*common
†

%s
...
[Time (s): cpu = 00:00:51 ; elapsed = 00:00:38 . Memory (MB): peak = 1013.758 ; gain = 0.0002default:default
S
GPhase 4 Post Placement Optimization and Clean-Up | Checksum: 19b70f246
*common
†

%s
...
%s
*constraints2o
[Time (s): cpu = 00:00:00 ; elapsed = 00:00:38 . Memory (MB): peak = 1013.758 ; gain = 0.0002default:default
Q
Releasing license: %s
83*common2"
...
€
treport_utilization: Time (s): cpu = 00:00:00 ; elapsed = 00:00:00.121 . Memory (MB): peak = 1013.758 ; gain = 0.000
*common
j
...
00:00:00.9562default:default2
1013.7582default:default2
0.0002default:defaultZ17-268

