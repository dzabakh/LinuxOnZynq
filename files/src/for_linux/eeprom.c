/* This program is hereby placed into the public domain. Of course the program is provided without 
...
(stored in buf) to eeprom at address addr, page-offset offset */ /* if len=0 (buf may be NULL in 
this case) you can reposition the eeprom's read-pointer */ /* return 0 on success, -1 on failure 
...
/* read len bytes stored in eeprom at address addr, offset offset in array buf */ /* return -1 on 
error, 0 on success */ 
